...
public interface TrackPanelConstants {
	...
	public static final Color NOTE_DISABLED /*     */= Color.getHSBColor(0.62f, 0.85f, 0.90f);
	public static final Color NOTE_OFF /*          */= Color.getHSBColor(0.62f, 0.00f, 0.50f);

	public static final Color NOTE_BAD_ENABLED /*  */= Color.getHSBColor(0.00f, 1.00f, 1.00f);
