...
public interface NoteGraphConstants {
	...
	public static final Color NOTE_DISABLED /**/= new Color(Color.HSBtoRGB(0.62f, 0.85f, 0.90f)); //new Color(48, 72, 143);
	public static final Color NOTE_OFF /*     */= new Color(Color.HSBtoRGB(0.62f, 0.00f, 0.50f)); //new Color(0x555555);

	public static final Color NOTE_BAD /*     */= new Color(Color.HSBtoRGB(0.00f, 1.00f, 1.00f));
	public static final Color NOTE_BAD_DISABLED = new Color(Color.HSBtoRGB(0.00f, 0.95f, 0.90f)); //new Color(143, 48, 48);
	public static final Color NOTE_BAD_OFF /* */= new Color(Color.HSBtoRGB(0.00f, 0.00f, 0.70f)); //new Color(0x888888);
	...
	public static final Color BKGD_DISABLED = new Color(0x262626);
